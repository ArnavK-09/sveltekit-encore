...
export function Environment(name: string): BaseURL {
  return `https://${name}-svelte-encore-app-id.encr.app`;
}
...
/**
 * Client is an API client for the svelte-encore-app-idEncore application.
 */
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "{{ENCORE_APP_ID}}-Generated-TS-Client (Encore/v1.46.4)";
    }
